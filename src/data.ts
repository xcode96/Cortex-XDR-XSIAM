...
export const QUERIES: Query[] = [
  {
    ...
    content_type: "bioc",
    severity: "Low",
    log_sources: ["Cortex XDR Agent"],
    mitre_ids: ["T1036.001", "T1036.005", "T1553.002"],
  ...
  },
  {
    ...
    content_type: "bioc",
    severity: "High",
    log_sources: ["Cortex XDR Agent", "Network Logs"],
    mitre_ids: ["T1567.002"],
  ...
  },
  {
    ...
    tags: ["USB Drive", "External Drive", "Data Exfiltration"],
    bioc_category: "exfiltration"
  },
  {
  ...
  },
  {
    ...
    severity: "High",
    log_sources: ["Windows Event Logs"],
    mitre_ids: ["T1098.007", "T1098", "T1078.002"],
    ...
    tags: ["Active Directory", "Privilege Escalation", "Persistence", "Identity"],
  ...
  },
  {
    ...
    content_type: "correlation",
    severity: "Medium",
    log_sources: ["Network Logs", "Firewall Logs"],
    mitre_ids: ["T1595.002", "T1595"],
    ...
    tags: ["Reconnaissance", "Scanning", "Network Security"],
  ...
  },
  {
    ...
    content_type: "correlation",
    severity: "Low",
    log_sources: ["Network Logs"],
    mitre_ids: ["T1594", "T1593"],
    ...
    tags: ["OSINT", "Reconnaissance", "Shodan"],
    category: "Reconnaissance"
  },
  {
    ...
    content_type: "bioc",
    severity: "Medium",
    log_sources: ["Cortex XDR Agent", "Cloud Audit Logs"],
    mitre_ids: ["T1591", "TA0043"],
    ...
    tags: ["Cloud", "AWS", "Azure", "Reconnaissance"],
    bioc_category: "reconnaissance"
  },
  {
    ...
    tags: ["Reconnaissance", "Active Directory", "Identity"],
    bioc_category: "reconnaissance"
  },
  {
    ...
    content_type: "correlation",
    severity: "High",
    log_sources: ["Network Logs", "DNS Logs"],
    mitre_ids: ["T1583.001", "T1583"],
    ...
    tags: ["DGA", "Resource Development", "Infrastructure"],
  ...
  },
  {
    ...
    tags: ["VPS", "Resource Development", "C2 Staging"],
    category: "Resource Development"
  },
  {
    ...
    tags: ["Cloud", "IAM", "Resource Development", "Accounts"],
  ...
  },
  {
    ...
    tags: ["Tool Acquisition", "Resource Development", "Github"],
    bioc_category: "resource_development"
  },
  {
    ...
    tags: ["Resource Development", "Certificates", "Infrastructure"],
    bioc_category: "resource_development"
  },
  {
    ...
    tags: ["Initial Access", "Phishing", "Macros"],
  ...
  },
  {
    ...
    content_type: "correlation",
    severity: "Critical",
    log_sources: ["Authentication Logs", "VPN Logs"],
    mitre_ids: ["T1133", "T1110"],
    ...
    tags: ["Initial Access", "Brute Force", "External Services"],
  ...
  },
  {
    ...
    tags: ["Initial Access", "Exploitation", "Webshell"],
    bioc_category: "initial_access"
  },
  {
    ...
    content_type: "correlation",
    severity: "High",
    log_sources: ["Authentication Logs"],
    mitre_ids: ["T1078", "T1078.003"],
    ...
    tags: ["Initial Access", "Valid Accounts", "Anomalous Login"],
    category: "Initial Access"
  },
  {
    ...
    tags: ["Initial Access", "Supply Chain", "Dependency Transition"],
    category: "Initial Access"
  },
  {
  ...
  },
  {
    ...
    content_type: "correlation",
    severity: "High",
    log_sources: ["Active Directory Logs"],
    mitre_ids: ["T1558.003"],
    ...
    tags: ["Credential Access", "Kerberoasting", "Active Directory"],
  ...
  },
  {
    ...
    content_type: "bioc",
    severity: "Critical",
    log_sources: ["Cortex XDR Agent", "File Logs"],
    mitre_ids: ["T1003.003"],
    query: "dataset = xdr_data \n| filter event_type = ENUM.FILE \n| filter action_file_path contains \"ntds.dit\" and action_file_name != \"lsass.exe\"",
    tags: ["Credential Access", "Active Directory", "NTDS"],
    bioc_category: "credential_access"
  },
  {
    ...
    content_type: "bioc",
    severity: "High",
    log_sources: ["Cortex XDR Agent", "PowerShell Logs"],
    mitre_ids: ["T1059.001", "T1003"],
    ...
    tags: ["Credential Access", "PowerShell", "Scripts"],
    bioc_category: "credential_access"
  },
  {
  ...
  },
  {
    ...
    tags: ["Discovery", "Network Scanning", "Internal"],
    category: "Discovery"
  },
  {
    ...
    tags: ["Discovery", "Process Discovery"],
    bioc_category: "discovery"
  },
  {
    ...
    tags: ["Discovery", "Identity", "Groups"],
    bioc_category: "discovery"
  },
  {
    ...
    tags: ["Discovery", "Network Discovery", "ARP"],
    bioc_category: "discovery"
  },
  {
  ...
  },
  {
    ...
    tags: ["Lateral Movement", "WMI", "Remote Exec"],
    bioc_category: "lateral_movement"
  },
  {
  ...
  },
  {
    ...
    tags: ["Lateral Movement", "WinRM", "PowerShell"],
  ...
  },
  {
    ...
    content_type: "correlation",
    severity: "High",
    log_sources: ["Active Directory Logs", "XDR Identity"],
    mitre_ids: ["T1550.002"],
  ...
  },
  {
    ...
    tags: ["Collection", "Automated Collection"],
    bioc_category: "collection"
  },
  {
  ...
  },
  {
    ...
    tags: ["Collection", "Browser", "Credentials"],
    bioc_category: "collection"
  },
  {
    ...
    content_type: "correlation",
    severity: "Critical",
    log_sources: ["DNS Logs", "Network Logs"],
    mitre_ids: ["T1071.004"],
  ...
  },
  {
    ...
    content_type: "correlation",
    severity: "High",
    log_sources: ["Network Logs", "Proxy Logs"],
    mitre_ids: ["T1071.001", "T1071"],
  ...
  },
  {
    ...
    tags: ["Exfiltration", "Archiving", "Staging"],
    bioc_category: "exfiltration"
  },
  {
    ...
    tags: ["Exfiltration", "ICMP", "Tunneling"],
    category: "Exfiltration"
  },
  {
    ...
    tags: ["Impact", "Ransomware", "Encryption"],
  ...
  },
  {
    ...
    tags: ["Impact", "Ransomware", "Recovery"],
    bioc_category: "impact"
  },
  {
    ...
    content_type: "bioc",
    severity: "High",
    log_sources: ["Cortex XDR Agent", "System Logs"],
    mitre_ids: ["T1489"],
    ...
    tags: ["Impact", "Inhibition", "Security Controls"],
    bioc_category: "impact"
  }
];
...
export const MITRE_MAPPINGS: Record<string, MitreTechnique> = {
  ...
  "T1078.002": {
    ...
    tactic_ids: ["TA0005", "TA0003", "TA0004", "TA0001"]
  },
  "T1078.003": {
    name: "Local Accounts",
